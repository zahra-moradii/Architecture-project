...
public class Sample {
    ...
    public static void main(String[] args) {
        ...
        ProgramCounter pc = new ProgramCounter("PC", "33X32", clock.getOutput(0)
        ...
        ControlUnit controlUnit = new ControlUnit("CONTROL_UNIT","7X9",
        ...
        for (int index = 0; index < 32; index++)
            ja_or_np_MuxOutput[index] = JA_OR_NP_MUX.getOutput(index);
        ...
        registerFile.addInput(memToRegMUX_Result);
        /* ********************************************************************************************************** */
